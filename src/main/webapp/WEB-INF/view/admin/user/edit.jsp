...
<html lang="en">
  ...
  <body>
    ...
    >
      <h4>Edit a user</h4>
      <hr />
      <form:form class="my-4" method="POST" action="/admin/user/edit" modelAttribute="user">
        <div class="form-group mb-3">
            <form:input path="id" hidden="true" type="text" name="id" id="id" class="form-control" />
        </div>
        <div class="form-group mb-3">
            <label for="email" class="form-label fw-bold">Email</label>
            <form:input path="email" disabled="true" type="email" name="email" id="email" class="form-control" />
        </div>
        <div class="form-group mb-3">
